 ...
 */
public class TravelDocsActivity extends Activity  implements  MXAccountUnlinkListener,MXAccountManager.MXAccountLinkListener, MXChatManager.OnCreateChatListener, MXChatManager.OnOpenChatListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(PreferenceUtil.getTravelBinderId(AppController.context).isEmpty())
    ...
    public void onOpenChatFailed(int i, String s) {
        Toast.makeText(TravelDocsActivity.this,"Please try again",Toast.LENGTH_LONG).show();
    ...
    public void onCreateChatFailed(int i, String s) {
        Toast.makeText(TravelDocsActivity.this,"OnCreateChatFailed",Toast.LENGTH_LONG).show();
    }
    ...
    private void startChatListActivity() {
        ...
        try {
            String strBIdner_id=PreferenceUtil.getTravelBinderId(AppController.context);
            MXChatManager.getInstance().openChat(PreferenceUtil.getTravelBinderId(AppController.context),  TravelDocsActivity.this);//"BDOVcBOwued9RfCFBetl1VB"
            this.finish();
...
*/
            ...
            protected AddUserResponse doInBackground(Void... params) {
                ...
                try {
                    ...
                    if(!agentAccessTokenModel.getAccesstoken().isEmpty())
                    {
                        ...
                        createBinder(PreferenceUtil.getTravelTokenId(AppController.context));
                        //}
                        ...
                        addUserResponse= createUserInBinderViewer(addUserResponse,EmailArray[(EmailArray.length-1)]);
                    }
    ...
    private AddUserResponse createUserInBinderViewer(AddUserResponse addUserResponse,String email){
    ...
    {
        String email=""+prefs.getString("email","");
        String binder_id=PreferenceUtil.getTravelBinderId(AppController.context);
    ...
    private void registerInBackground() {
        new AsyncTask<Void, Void, String>() {
            ...
            protected String doInBackground(Void... params) {
                ...
                try {
                    if (gcm == null) {
                        gcm = GoogleCloudMessaging.getInstance(TravelDocsActivity.this);
                    }
                    ...
                    try {
                        ...
                        Bitmap avatar = BitmapFactory.decodeStream(TravelDocsActivity.this.getAssets().open("FA01.png"));
                        ...
                        MXAccountManager.getInstance().setupUser(mxUserInfo, mxProfileInfo, AppController.context.getResources().getString( R.string.orgId), regid, TravelDocsActivity.this);
                    } catch (IOException e) {
                        Log.e(TAG, "Can't decode avatar.", e);
                    }

                    // Persist the regID - no need to register again.
                    PreferenceUtil.setGcmRegId(TravelDocsActivity.this, regid);
                    PreferenceUtil.setAppVersion(TravelDocsActivity.this, getAppVersion(TravelDocsActivity.this));
                } catch (Exception ex) {
                    msg = "Error :" + ex.getMessage();
                    Log.e(TAG, "Error when register on GCM.", ex);
                    // If there is an error, don't just keep trying to register.
