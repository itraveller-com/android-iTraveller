...
public class TempMOXTRAActivity extends Activity  implements  MXAccountUnlinkListener,MXAccountManager.MXAccountLinkListener, MXChatManager.OnCreateChatListener, MXChatManager.OnOpenChatListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EmailArray=""+prefs.getString("email","");
    ...
    public void onOpenChatFailed(int i, String s) {
        Toast.makeText(TempMOXTRAActivity.this,"Please try again",Toast.LENGTH_LONG).show();
    ...
    public void onCreateChatFailed(int i, String s) {
        Toast.makeText(TempMOXTRAActivity.this,"OnCreateChatFailed",Toast.LENGTH_LONG).show();
    }
    ...
    private void startChatListActivity() {
        ...
        try {
            ...
            MXChatManager.getInstance().openChat(PreferenceUtil.getTravelBinderId(AppController.context),  TempMOXTRAActivity.this);//"BDOVcBOwued9RfCFBetl1VB"
            this.finish();
            ...
            protected AddUserResponse doInBackground(Void... params) {
                ...
                try {
                    ...
                    if(!agentAccessTokenModel.getAccesstoken().isEmpty())
                    {
                        ...
                        userAccessToken = getAccessToken(userAccessToken, EmailArray,EmailArray);
                        ...
                        addUserResponse = createUserInBinder(addUserResponse,EmailArray);
                    }
    ...
    private void registerInBackground() {
        new AsyncTask<Void, Void, String>() {
            ...
            protected String doInBackground(Void... params) {
                ...
                try {
                    if (gcm == null) {
                        gcm = GoogleCloudMessaging.getInstance(TempMOXTRAActivity.this);
                    }
                    ...
                    try {
                        ...
                        Bitmap avatar = BitmapFactory.decodeStream(TempMOXTRAActivity.this.getAssets().open("FA01.png"));
                        ...
                        MXAccountManager.getInstance().setupUser(mxUserInfo, mxProfileInfo, AppController.context.getResources().getString( R.string.orgId), regid, TempMOXTRAActivity.this);
                    } catch (IOException e) {
                        Log.e(TAG, "Can't decode avatar.", e);
                    }

                    // Persist the regID - no need to register again.
                    PreferenceUtil.setGcmRegId(TempMOXTRAActivity.this, regid);
                    PreferenceUtil.setAppVersion(TempMOXTRAActivity.this, getAppVersion(TempMOXTRAActivity.this));
                } catch (Exception ex) {
                    msg = "Error :" + ex.getMessage();
                    Log.e(TAG, "Error when register on GCM.", ex);
                    // If there is an error, don't just keep trying to register.
